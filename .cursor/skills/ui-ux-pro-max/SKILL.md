---
name: ui-ux-pro-max
description: Comprehensive UI/UX design intelligence for building professional interfaces across web and mobile platforms. Provides 67 styles, 96 color palettes, 57 font pairings, 99 UX guidelines, and 100 industry-specific reasoning rules. Use when designing, building, creating, implementing, reviewing, fixing, or improving any UI/UX work including landing pages, dashboards, portfolios, e-commerce, and mobile apps.
---
...
```bash
python .cursor/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack html-tailwind
```
...
```bash
python .cursor/skills/ui-ux-pro-max/scripts/search.py "beauty spa wellness service elegant" --design-system -p "Serenity Spa"
```
...
python .cursor/skills/ui-ux-pro-max/scripts/search.py "elegant luxury serif" --domain typography
```

### Step 4: Stack Guidelines

```bash
python .cursor/skills/ui-ux-pro-max/scripts/search.py "layout responsive form" --stack html-tailwind
```
